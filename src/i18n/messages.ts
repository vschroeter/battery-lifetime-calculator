...
export const messages: Record<Locale, Record<string, string>> = {
  de: {
    ...
    deepSleepHint: 'Dauer wird automatisch als verbleibende Zeit nach allen aktiven Phasen berechnet.',
    ...
    inputs: 'Eingaben',
    leakageCurrents: 'Leckströme',
    leakageCurrentsHint: 'Leckströme sind permanente Lasten, die kontinuierlich 24 Stunden pro Tag fließen und zur Gesamtlast hinzugefügt werden.',
    label: 'Bezeichnung',
  ...
  en: {
    ...
    deepSleepHint: 'Duration is automatically calculated as the remaining time after all active phases.',
    ...
    inputs: 'Inputs',
    leakageCurrents: 'Leakage Currents',
    leakageCurrentsHint: 'Leakage currents are permanent loads that flow continuously 24 hours per day and are added to the total load.',
    label: 'Label',
