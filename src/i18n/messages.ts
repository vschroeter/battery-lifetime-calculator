...
export const messages: Record<Locale, Record<string, string>> = {
  de: {
    ...
    usableCapacityHint: 'Prozentsatz der nutzbaren Kapazität (Standard: 100%)',
    defaultInputMode: 'Standard-Eingabemodus für neue Phasen',
    modeA: 'Modus A: Dauer + Intervall',
    modeB: 'Modus B: Dauer + Häufigkeit',
  ...
  en: {
    ...
    usableCapacityHint: 'Percentage of capacity that can be used (default: 100%)',
    defaultInputMode: 'Default Input Mode for New Phases',
    modeA: 'Mode A: Duration + Interval',
    modeB: 'Mode B: Duration + Frequency',
    addPhase: 'Add Phase',
